...
class Main_Hub:
    ...
    def __init__(self, screen, clock, timer_handler):
        ...
        # Set player
        self.player = Player((150, 250), None)
        ...
        # Tilemap
        self.current_tilemap = Tilemap((0, 0), 50, ["assets/tileset/tile.png", "assets/tileset/wall.png", "assets/tileset/decorated_tile.png", "assets/tileset/player_spawn_tile.png"], matrix='src/scenes/scene_data/main_hub/hub_map')
